...
VALUES 
('Test User', 'test@gmail.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW(), 'PACIENTE'),
('Laura Martínez', 'laura.martinez@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '45 days', 'ADMIN'),
('Carlos Herrera', 'carlos.herrera@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '38 days', 'PROFESIONAL'),
('Ana Sofía Ríos', 'ana.rios@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '30 days', 'PACIENTE'),
('Sebastián Torres', 'sebastian.torres@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '22 days', 'PACIENTE'),
('Valentina Cruz', 'valentina.cruz@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '15 days', 'PACIENTE'),
('Andrés Morales', 'andres.morales@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '10 days', 'PACIENTE'),
('Camila Vargas', 'camila.vargas@ecobits.com', '$2a$10$eQf81ND77xFA45M/Z82QFeeKnHQ8vaG58L142.ql35P8oqMeuiGRK', NOW() - INTERVAL '5 days', 'PACIENTE')
...
VALUES
(false, true, 'General', 3, 'Bienvenidos a OPSY, un espacio donde exploramos cómo la tecnología transforma nuestra mente y bienestar. Aquí encontrarás recursos, profesionales y una comunidad que entiende los desafíos del mundo digital.', NOW() - INTERVAL '40 days', 12, false, 'Bienvenidos a OPSY', 2),
...
(false, true, 'Institucional', 0, 'OPSY nació con una misión clara: entender y mejorar el impacto de la tecnología en la salud mental. Gracias a cada persona que confió en este proyecto.', NOW() - INTERVAL '3 days', 23, false, '6 meses de OPSY: gracias comunidad', 2),
